...
#dmmshv dagýtýlan mama miktari sokak hayvanlarý verisi

dmmshv<- read_csv("C:/Users/winds/Desktop/G/1- CENG 3516 Statistical Computing 2020-2021 Bahar/çalýþma/sokakhayvanlarý/Daðýtýlan Mama Miktarý.csv")
